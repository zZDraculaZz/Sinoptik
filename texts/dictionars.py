...
EXPERIANCE = {
    "-15": "С таким холодом и водного охладения не нужно, надевай:\nподштаники, шерстяные носки, майку, шерстяной свитор, штаны, тёплую дублёнку, шапку-ушанку, любые тёплые перчатки и шарфик(тёплый),а и про валенки не забудь.",
    "0": "Морозная погодка,человек,ты уверен что хочешь гулять? Хотя кого я спрашиваю...\nнадевай тёплые носки, майку, подштаники, шерстяной свитор, стёганную куртку, шапку, ботинки и тёплый шарфик.",
    ...
    "23+": "Слушай такую жару даже мой радиатор не выдерживает, сказал бы идти в трусах, но где мои робоманеры, надевай:\nмайку, шорты(юбку) и любую свободную для ног обувь.",
}
...
COMMAND_TEXT = {
    ...
    "help": "Если хочешь получить совет по человеческой одежде, то просто нажми \n/start"
            ...
            "где есть кнопка с включением GPS, дальше тебе просто потребуется нажать /start и продолжить общение со мной."
...
COMMON_TEXT = {
    ...
    "location_not_found": "Пресвятые шестерёнки! Я не обнаружил твою локацию в своих списках, попробуй начать с самого начала /start"
}